...
CREATE TABLE `dich_vu` (
  ...
  `ma_kieu_thue` int(11) DEFAULT NULL,
  `ma_loai_dich_vu` int(11) DEFAULT NULL,
...
CREATE TABLE `hop_dong` (
  ...
  CONSTRAINT `hop_dong_ibfk_2` FOREIGN KEY (`ma_dich_vu`) REFERENCES `dich_vu` (`ma_dich_vu`),
  CONSTRAINT `hop_dong_ibfk_3` FOREIGN KEY (`ma_khach_hang`) REFERENCES `khach_hang` (`ma_khach_hang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hop_dong_chi_tiet` (
  ...
  `ma_dich_vu_di_kem` int(11) DEFAULT NULL,
...
CREATE TABLE `khach_hang` (
  ...
  `ma_loai_khach` int(11) DEFAULT NULL,
...
CREATE TABLE `nhan_vien` (
  ...
  `ma_bo_phan` int(11) DEFAULT NULL,
...
-- Dump completed on 2021-11-15 18:10:21
