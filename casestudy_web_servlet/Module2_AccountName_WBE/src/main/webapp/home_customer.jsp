...
<div class="container-fluid" style="border-style:solid">
    <div class="row">
        <div class="col-lg-6 fw-bolder fs-3">
            <span style="font-size : 35px"><strong>CUSTOMER HOMEPAGE</strong></span>
        </div>
        <div class="col-lg-6 fw-bolder fs-3">
            <form class="d-flex" method="post">
                <input type="hidden" name="action" value="search">
                <input type="search" name="id" placeholder="id search customer">
...
<div class="container-fluid div1">
    <div class="row">
        <div class="col-lg-4 fw-bolder fs-3">
            ...
            <p><a href="/customerServlet?action=delete">Delete Customer</a></p>
            <p><a href="/customerServlet?action=edit">Edit Customer</a></p>
        </div>
